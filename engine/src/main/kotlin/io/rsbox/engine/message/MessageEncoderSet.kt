...
class MessageEncoderSet {
    ...
    fun init() {
        ...
        put(SetCameraPosEncoder(), SetCameraPosMessage::class.java)
        put(SetCameraAngleEncoder(), SetCameraAngleMessage::class.java)
